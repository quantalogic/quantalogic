...
Your task is to implement a new Tool RipGrepTool that uses ripgrep to search for text blocks in a file.

<rip_grep_tool>
    <!-- directory path to search in  -->
    <direrctory_path>./path/to</direrctory_path>
    <!-- regex to search for RUST syntax -->
    <regex>.*</regex> 
...
Result a  Returns: A formatted string containing search results with context.
